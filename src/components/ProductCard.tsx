  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
      ...
      <div className="relative h-64 bg-gradient-to-br from-purple-50 to-pink-50">
        ...
        {/* Gender Badge */}
        <div className="absolute top-3 right-3 bg-purple-600 text-white rounded-full px-3 py-1">
        ...
        {product.originalPrice && (
          <div className="absolute top-3 left-1/2 transform -translate-x-1/2 bg-red-500 text-white rounded-full px-2 py-1">
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="text-sm text-purple-600 font-medium bg-purple-50 px-2 py-1 rounded">
            {product.ml}ml
          </div>
        </div>
