...
export const AboutSection: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'আমাদের পারফিউম ৮-৪৮ ঘণ্টা পর্যন্ত টিকে থাকে, যা আপনাকে সারাদিন আত্মবিশ্বাসী রাখবে।'
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Mahima Perfumery Co. একটি বিশ্বস্ত ব্র্যান্ড যা শিক্ষার্থী, চাকরিজীবী, শিক্ষক ও পেশাজীবীদের জন্য 
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <div className="space-y-6">
            <h3 className="text-3xl font-bold text-gray-900">আমাদের গল্প</h3>
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                ...
                যা শিক্ষার্থী, চাকরিজীবী, শিক্ষক ও পেশাজীবীদের নাগালের বাইরে। এই সমস্যার সমাধানে 
                আমরা শুরু Mahima Perfumery Co. এর পক্ষ থেকে Aroma কালেকশন শুরু করি।
                আমাদের পারফিউম গুলো অন এন্ড এভারেজ ১২ ঘন্টা + ঘ্রাণ থাকে এবং বাজেট ও হাতের নাগালে।
                ৩০ মিলি এর দাম ১৫০-৩৫০ টাকার মধ্যে (এভারেজ মারকেট প্রাইস থেকে অনেক কম) ।  
                মূলত সীমিত লাভে কোয়ালিটিফুল পারফিউম শিক্ষার্থী, চাকরিজীবী, শিক্ষক ও পেশাজীবীদের কাছে পৌছে দেওয়াই আমাদের উদ্দেশ্য।
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-20">
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-8 rounded-2xl">
            <h4 className="text-2xl font-bold text-gray-900 mb-4">আমাদের লক্ষ্য</h4>
            <p className="text-gray-700 leading-relaxed">
              প্রতিটি শিক্ষার্থী, চাকরিজীবী, শিক্ষক ও পেশাজীবীদের কাছে প্রিমিয়াম কোয়ালিটির পারফিউম সাশ্রয়ী মূল্যে 
              পৌঁছে দেওয়া এবং তাদের আত্মবিশ্বাস ও ব্যক্তিত্ব বৃদ্ধিতে সহায়তা করা।
            </p>
          </div>
          
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-8 rounded-2xl">
            <h4 className="text-2xl font-bold text-gray-900 mb-4">আমাদের দৃষ্টিভঙ্গি</h4>
            <p className="text-gray-700 leading-relaxed">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-2xl p-12 text-center">
          <h3 className="text-3xl font-bold mb-6">আমাদের মূল্যবোধ</h3>
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <h4 className="text-xl font-semibold mb-2">সততা</h4>
              <p className="text-purple-100">
                আমরা সর্বদা সৎ ও স্বচ্ছভাবে ব্যবসা পরিচালনা করি।
              </p>
            </div>
            <div>
              <h4 className="text-xl font-semibold mb-2">গুণগত মান</h4>
              <p className="text-purple-100">
                কোয়ালিটিতে কোনো প্রকার আপস করি না আমরা। একবার ইউজ করলেই বুঝতে পারবেন ( ঘ্রাণ এর কোয়ালিটি এবং স্থায়িত্ব অনেক উন্নতমানের)

              </p>
            </div>
            <div>
              <h4 className="text-xl font-semibold mb-2">গ্রাহক সেবা</h4>
              <p className="text-purple-100">
